...
const Home = memo(() => {
  ...
  const { goodPriceInfo, highScoreInfo, disCountInfo, hotrecommenddestInfo, longforInfo, plusInfo } = useSelector(
    (state) => ({
  ...
  return (
    <HomeWrapper>
      ...
      <div className="content">
        ...
        {plusInfo && <HomeSectionV3 infoData={plusInfo}></HomeSectionV3>}
      </div>
    </HomeWrapper>
  );
});
